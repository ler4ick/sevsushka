...
Rectangle {
    ...
    //эти свойства используются как константы, доступны также извне
    ...
    //определяем "кликабельную" зону равную поверхности всей кнопки
    MouseArea {
        id: buttonMouseArea
        anchors.fill: parent //размер равен размеру "родителя"
        onClicked: buttonClick()

        //если равно true, то будет вызываться onEntered и onExited при наведении/удалении курсора
